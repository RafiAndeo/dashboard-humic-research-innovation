...
@endif
    ...
    <form action="{{route('hki.add_member_to_hki')}}" method="post" class="flex pb-10">
        @method('POST')
        @csrf
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex space-x-3">
                                <form action="{{route('hki.delete_member_from_hki', ['hki_id' => $id, 'member_id' => $d->member_id])}}" method="post">
                                    @csrf
                                    @method('DELETE')
