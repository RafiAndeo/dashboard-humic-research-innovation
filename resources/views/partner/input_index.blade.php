...
@section('content')
    ...
    <div class="flex mt-10 space-x-5 mb-4">
        <a href="{{route('partner.create')}}" class="py-2 px-4 rounded bg-green-500 space-x-2 flex text-white hover:bg-green-600">
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex space-x-3">
                            <a href="{{route('partner.edit', ['id' => $d->id])}}" class="bg-yellow-400 block rounded py-2 px-4">Edit</a>
                            <form action="{{route('partner.destroy', ['id' => $d->id])}}" method="post">
                                @csrf
                                @method('DELETE')
