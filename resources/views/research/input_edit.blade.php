...
<div>
    ...
    @endforeach
@endif
    <form action="{{route('research.update', ['id' => $data->id])}}" method="post" class="flex pb-10">
        @method('PUT')
        @csrf
        <div class="w-1/2 space-y-4">
            <div class="space-y-2">
                <label for="tahun_diterima" class="">Tahun Diterima</label>
                <input type="number" name="tahun_diterima" value="{{$data->tahun_diterima}}" class="w-full py-2 px-4 rounded border border-black" placeholder="Tahun Diterima" required>
            </div>
            <div class="space-y-2">
                <label for="tahun_berakhir" class="">Tahun Berakhir</label>
                <input type="number" name="tahun_berakhir" value="{{$data->tahun_berakhir}}" class="w-full py-2 px-4 rounded border border-black" placeholder="Tahun Berakhir" required>
            </div>
            <div class="space-y-2">
                <label for="judul" class="">Judul</label>
                <input type="text" name="judul" value="{{$data->judul}}" class="w-full py-2 px-4 rounded border border-black" placeholder="Judul" required>
            </div>
            <div class="space-y-2">
                <label for="tkt" class="">TKT</label>
                <input type="number" name="tkt" value="{{$data->tkt}}" class="w-full py-2 px-4 rounded border border-black" placeholder="TKT" required>
            </div>
            <div class="space-y-2">
                <label for="grant" class="">Grant</label>
                <input type="number" name="grant" value="{{$data->grant}}" class="w-full py-2 px-4 rounded border border-black" placeholder="Grant" required>
            </div>
            <div class="space-y-2">
                <label for="skema" class="">Skema</label>
                <select type="number" name="skema" class="w-full py-2 px-4 rounded border border-black" placeholder="Skema" required>
            ...
            <div class="space-y-2">
                ...
                <select name="tipe_pendanaan" id="" class="w-full py-2 px-4 rounded border border-black" placeholder="Tipe Pendanaan" required>
                    <option value="{{$data->tipe_pendanaan}}">{{$data->tipe_pendanaan}}</option>
            ...
            <div class="space-y-2">
                ...
                <input type="number" name="lama_penelitian" value="{{$data->lama_penelitian}}" class="w-full py-2 px-4 rounded border border-black" placeholder="Lama Penelitian (Tahun)" required>
            </div>
            <div class="space-y-2">
                <label for="keterangan" class="">Keterangan</label>
                <input type="text" name="keterangan" value="{{$data->keterangan}}" class="w-full py-2 px-4 rounded border border-black" placeholder="Keterangan" required>
            </div>
            <div class="space-y-2">
